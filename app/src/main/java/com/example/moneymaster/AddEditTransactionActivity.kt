...
class AddEditTransactionActivity : AppCompatActivity() {
    ...
    private fun setupCategoryDropdown() {
        val categories = arrayOf(
            ...
            "Health & Fitness", "Travel", "Education", "Salary", "Investments", "Business", "Other"
        )
        val adapter = ArrayAdapter(this, android.R.layout.simple_dropdown_item_1line, categories)
        findViewById<android.widget.AutoCompleteTextView>(R.id.categoryAutoComplete).setAdapter(adapter)
    }
    ...
    private fun setupDatePicker() {
        ...
        dateEditText.setOnClickListener {
            DatePickerDialog(this, datePickerDialog, calendar.get(Calendar.YEAR),
    ...
    private fun saveTransaction() {
        val isExpense = findViewById<RadioButton>(R.id.expenseRadioButton).isChecked
        ...
        val newTransaction = Transaction(
            id = 0, // ID will be generated by MainActivity
            title = title,
            amount = amount,
            date = date,
            category = category,
        ...
        val resultIntent = Intent().apply {
            putExtra(EXTRA_TRANSACTION, newTransaction)
        }
